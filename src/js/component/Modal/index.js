          ...
          >
            <div className="col-md-6">
              ...
              <input
                ...
                required
              />
              <div className={isErrorName ? "invalid text-danger" : "invalid-feedback"}>
                {errorMessage}
              </div>
            </div>
            <div className="col-md-6">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  required
                />
                <div className={isErrorEmail ? "invalid text-danger" : "invalid-feedback"}>
                  {errorMessage}
                </div>
              </div>
            </div>
            <div className="col-md-6">
              ...
              />
              <div className={isErrorLink ? "invalid text-danger" : "invalid-feedback"}>
                {errorMessage}
              </div>
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6">
              ...
              />
              <div className={isErrorRange ? "invalid text-danger" : "invalid-feedback"}>
                {errorMessage}
              </div>
            </div>
            <div className="col-md-6">
            ...
            <div className="col-12">
              <div className="form-check">
                ...
                <div
                  className={isErrorCheckbox ? "invalid text-danger" : "invalid-feedback"}
                >
                  {errorMessage}
                </div>
              </div>
